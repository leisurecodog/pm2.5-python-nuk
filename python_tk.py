...
def handler(temp_value, a):
    ...
    label3 = tk.Label(window, text=lb3_data, bg='red', font=('Arial',12), width = 30, height=2 )
...
def new_station(test3):
    ...
    for i in range(len(test3)):
        ...
        tmp = Button(window, text=str(test3[i]), font = ('Arial',10))
        tmp.place(x=135, y=22*i, width=110, height=22)
...
btn_frame = Frame(window, relief=GROOVE, bg='purple').pack() # save main btns(blue btns)
